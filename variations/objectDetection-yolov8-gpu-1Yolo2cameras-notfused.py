...
# Results are stored in their separate threads, not fused into a world coordinate system
            ...
            if objects.is_new:
                ...
                if len(obj_array) > 0:
                    for obj in obj_array:
                        ...
                        # Now point_cam2 contains the coordinates of the detected object from camera 1 in the second camera's space
...
def main():
    ...
    with open('calibration/calibration01.json', 'r') as f:
        calibration = json.load(f)

    # Calculate the transformation matrix between the cameras
    trans1to2 = calculate_transformation_matrix(
        calibration['38845823']['world']['rotation'],
        calibration['38845823']['world']['translation'],
        calibration['37771754']['world']['rotation'],
        calibration['37771754']['world']['translation'])
