...
import matplotlib.pyplot as plt # for visualization testing
...
def main_loop(i, svo_filepath=None, trans1to2=None):
    ...
    # Craete dictionary for shared coordinates
    # shared_coordinates = {}
            ...
            if objects.is_new:
                ...
                if len(obj_array) > 0:
                    for obj in obj_array:
                        ...
                        # Fill shared coordinates dictionary with object ID and world coordinates(point_shared)
                        # shared_coordinates[obj.id] = points_shared
